...
app.layout = html.Div([
    ...
    html.H1(children='Automobile Sales Statistics Dashboard', style={'textAlign':'center','color':'#503D36','font-size':24}),#Include style for title
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph( figure=px.bar(avr_vdata,
          x='Month',
          y='Automobile_Sales',
          labels={'Month': 'Months', 'Automobile_Sales': 'Average Automobile Sales'},
